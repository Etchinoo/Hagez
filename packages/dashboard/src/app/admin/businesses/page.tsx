  ...
  return (
    <div style={styles.page}>
      ...
      {loading ? (
        ...
        <div style={styles.empty}>No {tab === 'all' ? '' : tab} businesses found.</div>
      ) : (
...
const styles: Record<string, React.CSSProperties> = {
  ...
  rejectBtn: { padding: '6px 14px', background: '#FEE2E2', border: 'none', borderRadius: '6px', fontSize: '13px', fontWeight: 600, color: '#B91C1C', cursor: 'pointer' },
  suspendBtn: { padding: '6px 14px', background: '#FEF3C7', border: 'none', borderRadius: '6px', fontSize: '13px', fontWeight: 600, color: '#92400E', cursor: 'pointer' },
